...
def detect_objects_in_frame(frame):
    ...
    object_size = 0  # Size of the object (bounding box area)
    ...
    if len(results[0].boxes) > 0:
        for box in results[0].boxes:
            ...
            if "orange" in label or "sports ball" in label or "bird" in label:
                ...
                # Calculate the object size (bounding box area)
                object_size = (x_max - x_min) * (y_max - y_min)
